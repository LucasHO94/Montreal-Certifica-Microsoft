  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 font-sans selection:bg-blue-200">
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-12 gap-16 lg:gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-7">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-[1.15] mb-6 text-slate-900 tracking-tight">
              {t('lp_hero_title_1', 'Aprove de Primeira nas ')} <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Certificações Microsoft</span>
            </h1>
            ...
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-slate-500 font-medium">Engenheiro Cloud Azure</div>
                    </div>
                </div>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100 transform md:-translate-y-4 shadow-xl border-blue-100 ring-4 ring-blue-50">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-slate-500 font-medium">Arquiteta de Soluções Azure</div>
                    </div>
                </div>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-slate-500 font-medium">Administrador Azure Júnior</div>
                    </div>
                </div>
            </div>
          </div>
      ...
      <footer className="bg-slate-950 text-slate-500 py-12 text-center text-sm font-medium">
        <p>© {new Date().getFullYear()} {t('hub_brand', 'Certificações Microsoft')}. {t('lp_footer_disclaimer')}</p>
