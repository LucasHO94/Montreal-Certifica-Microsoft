...
export default function Dashboard({ session }) {
  ...
  const startSimulator = (type, mode = 'tutorial') => {
    navigate(`/cert/${certId}/simulator/${type}?mode=${mode}`);
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans pb-20 md:pb-8 relative">
                ...
                <div className="bg-white rounded-[2.5rem] w-full max-w-2xl shadow-2xl transform transition-all animate-fade-in-up" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="p-8">
                        ...
                        <div className="mt-10 flex gap-4">
                            ...
                            <button 
                                onClick={() => navigate(`/cert/${certId}/simulator/review?historyId=${selectedHistoryItem.id}`)}
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 grid lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <KPICards rawHistory={rawHistory} dailyGoal={10} />

          {/* TopicProgress — Progresso por Domínio */}
          <TopicProgress
            history={history}
            certConfig={certConfig}
            onStartTopic={(domain) => navigate(`/cert/${certId}/study?domain=${encodeURIComponent(domain)}`)}
          />
