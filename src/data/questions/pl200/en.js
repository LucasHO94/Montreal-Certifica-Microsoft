export const questions = [
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Customize the System / Individual record: Customize the System is used to change the structure of entities/forms, not to enable auditing; and the Individual record only shows the history of one specific record, not the centralized login log."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Templates area of the Admin Center: This area lists ready-to-install app templates; it is not where you create table views."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Assigning System Administrator to all students: This violates the principle of least privilege and grants full access to the entire environment configuration, not just the free courses."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Approve the workflow (step 2): Approval is a manual verification pause, not the 'run now' setting that triggers the action immediately."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "1. Dynamics 365 Workflow to send SMS: Classic Dynamics workflows have no native SMS-sending action; that requires the Power Automate SMS connector.",
        "1. Microsoft Flow for the status email: Sending a simple email when the status changes is a classic Dynamics Workflow scenario, simpler than configuring a Power Automate flow for it."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Only removing the access privileges without deactivating BPFA: The BPF would remain active and listed for manual switching; you must deactivate AND remove the privileges to prevent its use."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Global: This scope would apply the rule to all forms of every entity in the environment, far beyond what is needed for a canvas app with a single table."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Dynamics 365 Sandbox instance | Licenses: Configuring this in the Sandbox does not affect Production; and Licenses control which apps the user can open, not access to data.",
        "Microsoft 365 admin center | Licenses: The area is correct, but Licenses don't control read/write access to data; that's the job of Groups."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "None: This type doesn't exist as a valid table ownership option in Dataverse; every custom table needs a defined ownership type."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Base record type: Account: The requirement is to detect duplicates when creating the Opportunity, so the rule must have Opportunity as the base, not Account."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Set privileges: Privileges are part of a security role and control actions on records within the environment, not the visibility of the environment itself."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Custom: This behavior does not automatically propagate owner reassignment; you would have to configure each action manually, unlike the Parental behavior."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Office 365 service administrator (step 1): This role does not have permission to create new users in the tenant; that requires the Global Administrator.",
        "Dynamics 365 service administrator (step 2): This role does not assign internal roles; the one who assigns roles within Dynamics is the system administrator."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "1. 1:N for the email lookup: The Applicant's email should reference the Contact with N:1 (many loans to one contact), not 1:N.",
        "3. 1:1 for the last requirement: Native 1:1 relationships don't exist in Dataverse in the expected way; the correct answer uses N:1."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Inverting the groupings (State first, Account second): The requirement asks to group first by Owner and, within each, by State/Province — swapping the order changes the chart hierarchy."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Environment Admin: Grants full control of the environment, including security and backups, far beyond what is needed just to create apps that consume existing data."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Using Power Automate to check for inactivity: This would be a manual, failure-prone workaround; the Power Platform admin center already offers a native session timeout, with no custom automation needed."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Kanban on 'All Opportunities': The correct view for the team to manage their own opportunities is 'My Opportunities', with both controls configured on it."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Enabling auditing only at the table level without restricting to the columns: This would log changes to ALL columns of the Account table, violating the requirement to track only the two needed columns."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        "No: This would be incorrect, because Dataverse Search (Relevance Search) recognizes morphological variations of a word (e.g., 'running' from 'run'), allowing you to find the note even when typing the root form."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "1. Workflow for the read-only field: Classic workflows don't control UI properties in real time on the screen; that's the job of a Business Rule, which reacts instantly as data is entered.",
        "1. Instant flow for the read-only field: Instant flows are triggered manually by a button; they don't react automatically to value changes while the form is being filled in."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Microsoft Excel template: This is for exporting/importing data in bulk via spreadsheet, not for creating and sharing table views.",
        "Templates area: This contains ready-made document and app templates; it is not where you define a table's views."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Mobile form and Virtual entity: A mobile form is just a responsive version of the form, and a virtual entity connects external data — neither one solves embedding and editing data from another related table in the main form."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Power Platform admin center with Local Security policy: The correct area would be Azure Active Directory, and Local Security policy is a Windows configuration local to the machine, not network-based conditional access control."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "B. The currency is used by an active business process: Business processes do not block deactivating currencies; the only real blocker is the currency being the environment's base currency."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Environment Admin: Grants full administrative control of the environment, including user management and backups — exceeding what is needed just to create apps that consume existing data."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "1. Access team first: Access Teams have no record ownership nor their own security hierarchy — they are for sharing ad hoc access, not for reflecting the organizational structure via Azure AD groups.",
        "1. Microsoft Teams team: This is only a collaboration integration with Teams channels, unrelated to security or record ownership in Dataverse."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Rename the Brazilian currency: Renaming does not prevent creating new records with that currency; you must deactivate it to block its use in future transactions."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Adding management to an access team (instead of the sales team): The SALES team should be added to MANAGEMENT's access team template (not the other way around), since it's management that needs to view the sales data."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Change the publisher's prefix AND Edit the option set directly: The first part is correct, but the second action is impossible — you cannot edit the base numeric value after it's created; you must delete and recreate it."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Lookup field: This only creates a reference to a single related record; it does not sum or aggregate values from multiple child records.",
        "Option set: This is a fixed list of predefined values for manual selection; it doesn't calculate or aggregate anything automatically."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Enable connections and Relevance search: Connections relate records freely, and Relevance search is a search feature — neither one enables the table for the App for Outlook.",
        "Enable for activities is correct, but Enable editable grid is just a visual inline-editing option — it has nothing to do with syncing the table in Outlook, which requires Enable for mobile."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Creating an alternate key and not mapping 'Parent Name': This would completely ignore the hierarchical relationship between parent and child accounts, which is exactly the requirement of the scenario."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Step 2 with the Dynamics 365 Service Admin: This role handles service operations (backups, downtime); it does not assign security roles to users — that's the job of the Dynamics System Admin.",
        "Step 1 with the Office 365 Service Admin: This role does not have permission to create new users in the tenant; creating users requires the Global Admin."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Assign a Security Role for App access and Share record for the table: Step 1 would resolve data access, not the app icon; and sharing a record grants access to a specific row, not the entire table.",
        "Add to an Access Team: Grants access to specific records shared with the team; it doesn't resolve the app icon's visibility nor structural access to the table."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Quick Find in step 1: It tolerates no typos and doesn't read inside attachments — it only works with exact matches or wildcards (*).",
        "Categorized Search in step 2: It cannot index or search text inside the content of attached files (PDF/Word); it only searches structured table fields."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Quick View in step 1 (detailing the main record): Quick View only shows data from a related record in read-only mode within another form; it doesn't detail the main record itself — that's the job of the Main Form."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Power Automate with 'Send Email': Sending an email doesn't prevent the record from being saved nor show an error to the user; they would only be notified afterward, without blocking the save with the empty field."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Answering 'No' for Grouping and 'No' for Mobile: The Editable Grid DOES support grouping records and DOES work on mobile devices — only composite fields are not directly editable in it.",
        "Answering 'Yes' to editing a composite field: Composite fields (like Address) require editing the individual columns separately; they are not directly editable in the Editable Grid."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Power Apps Portal in step 1: This is more robust than needed for a simple entity-based feedback survey, and Microsoft Forms in step 2 does not link automatically and securely to Dynamics tables.",
        "Microsoft Excel Online in step 2: This doesn't provide a secure, authenticated area for the customer to view and update data linked directly to Dynamics tables; that requires a Power Apps Portal."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Add Find Columns: This controls which columns appear as quick-find results; it doesn't prevent the field from being used as a filter criterion in Advanced Find.",
        "Security Roles: These control who can read/write the field; they don't specifically prevent it from appearing as a filter option — that's controlled by the field's 'Searchable' property."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Using ForAll() to iterate and uncheck: Power Fx does not allow directly changing the checked state of each checkbox individually within a ForAll() loop this way; it's simpler to use Reset() on the entire gallery."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Answering Yes to all 3 items: Collect creates a new duplicate record instead of updating when the Id already exists (item 2 is No), and adding a new column to Collect doesn't fail silently — item 3 is also No.",
        "Answering No/No/Yes: The first item is Yes, because Collect automatically creates the 'People' table on the first call, even if it didn't previously exist in the app."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Timeline correct in step 1, but Social Insights in step 2: This component displays mentions on external social media, not a simple list of the user's pending activities — that's the job of the 'Lists' component."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Office 365 admin center: This manages licenses, users, and Microsoft 365 services in general, without any tool to design or export Power Apps Solution packages."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "In individual tables in the web app: There is no option to export translations table by table in isolation; the process is done at the aggregated level of the entire Solution."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "OnCheck/OnUncheck populating and removing from a collection: Even by managing the collection in code, this doesn't visually revert the checked state of the checkboxes on the screen; you need to use Reset() on the gallery for that."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Chart: This displays aggregated data visually (bars, pie), not a detailed list of events organized by location in calendar format — that's the job of a View with the Calendar control."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Answering No to the 1st statement (cross-screen access): Variables created with Set() are global by default and can be accessed from any screen of the app, including Screen2."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Export to Power BI and import as a visualization: This creates a useless external dependency — Power BI doesn't return the chart to Dynamics as a native visualization usable by the team."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Group before Area: You cannot create a navigation Group without it being inside an already existing Area — the Area is the top-level container and must come first.",
        "Area followed directly by Subarea, without a Group: The standard, organized build sequence is Area to Group to Subarea, following the expected navigation hierarchy."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Inherited permissions disabled: This affects how a child page inherits access rules from its parent page in the site tree, but it's not the reason here — the actual block is the 'available to everyone' option being unchecked on the page itself."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Local user + Contact record: The first part is just an alternative identity provider to Azure AD, but the second step needs to associate the Contact with the Web Role, which is missing here.",
        "Contact record + Azure Active Directory: The first step is correct, but the portal doesn't use Azure AD directly to grant content permissions — that's the job of the Web Role associated with the Contact."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Portals Studio for step 2: Portals Studio is correct for themes/branding (step 1), but infrastructure settings such as URL and SSL (step 2) require the Power Apps portals admin center, not Dataverse system settings.",
        "Dataverse system settings for step 1: This area has no visual theme customization options; that's done in Portals Studio."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Using the Account table as the data source: Portal users are stored as Contact records, not Account records; using the wrong table would not correctly list who has a login on the site."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Answering No to sign-in via Entra ID: The company explicitly requires employees to sign in through Microsoft Entra ID (Azure AD); this part should also be 'Yes'.",
        "Answering No to external sign-in with a personal Microsoft account: The scenario explicitly asks for external users to sign in with a personal Hotmail/Outlook account, so this part should also be 'Yes'."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Open Registration: No | External Sign-in: Yes: Even by blocking free registration, allowing sign-in via social networks would still open an uncontrolled external entry point, contradicting the requirement.",
        "Open Registration: Yes | External Sign-in: No: Leaving registration open would allow anyone on the internet to freely create an account, even without using social networks — violating the requirement to restrict to pre-approved users."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Create a Power Automate flow to inject the CSS: This would be an unnecessarily complex and unstable solution for a visual styling requirement; the native way is to upload the CSS in the Themes pane of the Portals Studio."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Organization ownership and 'Create a new activity': Organization ownership doesn't allow restricting access by user/business unit, and 'Create a new activity' is not the option that links emails/tasks to the table — that's 'Enable for activities'.",
        "Organization ownership: Even with 'Enable for activities' correct, Organization ownership prevents restricting access by specific user/team, an explicit requirement of the scenario."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Specific form in step 1 (Canvas App): Business rules in Canvas Apps don't run tied to a specific Model-driven form; the correct scope for Canvas is 'Table', which runs on the server.",
        "Table is correct in step 1, but 'All forms' in step 2 would apply the rule to any Model-driven form, violating the requirement to restrict it to a single specific form."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Selenium IDE + Firefox + Gateway: This is missing Power Automate Desktop, which is the actual engine that records/runs the steps; without it, nothing works even with the right browser and gateway.",
        "Edge + Firefox + Selenium: Two browsers and Selenium, but without Power Automate Desktop or the Gateway, there's no way to record steps or connect the cloud to the local PC."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Choosing 'Select text on screen' before starting the recording: This option is only available AFTER the recording has started; you cannot configure the output before you begin recording.",
        "Entering the output name/description before starting the recording: This step is the last in the process, done after you've already selected the information on screen; it cannot come before the recording."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Inverting the order: The Action step is for the manual button, and Classic Workflow is not the recommended option to minimize maintenance compared to Power Automate.",
        "Classic Workflow in step 1: Microsoft recommends Power Automate over Classic Workflows to minimize maintenance effort for new logic within BPFs."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Ensure matching entity AND Add a step: Adding a step to the action is not a requirement for it to appear in the Action Step; what's missing is selecting 'Run as an on demand process'.",
        "Run as an on demand process AND Activate the action: This is missing ensuring the action's entity matches the BPF stage — activating alone doesn't solve that."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "1. Attended | 2. Unattended (inverted): The overnight process with no one watching is Unattended, and the on-demand process requested by an operator is Attended — this option swaps the two.",
        "1. Custom connector | 2. Unattended: With no REST API available, no connector works; the only viable option is a UI Flow to automate the interface visually."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Approve the workflow / Publish / View chart: Approval pauses execution manually, publishing only activates the flow (it triggers nothing), and 'View chart' doesn't send an email — none of these actions meet the requirement."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Mixing valid and invalid actions (e.g., Set requirement levels + Show/hide + Set values): Even if two of the three are valid in Canvas Apps, the presence of one interface action (show/hide) already invalidates the combination as a complete answer."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "1. BPF | 2. Scheduled: A Business Process Flow is a visual progress bar inside the app; it can't automate clicks in a system without an API.",
        "1. Desktop Flow | 2. Automated: Step 1 is correct, but an Automated flow triggers on a system event, not on a scheduled date/time — that's the job of the Scheduled flow."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "1. Custom Step | 2. Conditional Branch | 3. Check Condition: 'Custom Step' is not a valid BPF step type for this logic; and the order of steps 2 and 3 is also inverted.",
        "1. Default Action | 2. Check Condition | 3. Default Action: Repeating 'Default Action' twice doesn't cover the intermediate probability ranges, which require Conditional Branches."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Configure workflows in step 1: Workflows automate actions behind the scenes, but they don't create the visual stage progress bar that guides the user — that's the job of the BPF.",
        "Views and charts + Insights: These show existing data and automatic analytics, but none of them divide the process into structured, manageable stages — that's the job of the BPF with Stages."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Sign in to the Admin Center: The Power Platform admin center manages environments and capacity; it's not where you build an automation flow — that's done directly in Power Automate.",
        "Selecting the connector and generating a key before creating the blank flow: The correct order is to first create the blank flow in Power Automate and, within it, select the connector and authenticate."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Entity component of the default solution: This component edits the table's structure (fields, forms, views); it doesn't control the visibility of command bar buttons such as 'Flow'."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Ensure there are no active user sessions on the device: This phrasing is ambiguous/insufficient — the requirement is that ALL sessions be signed out, not merely 'no active session', which could still include a locked, unfinished session."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "triggerBody() = 'OverdueDate' >= 7: This uses equality syntax (=) instead of a numeric comparison, and the order of the operands is incorrect for a valid Power Automate expression.",
        "@equals(triggerBody()?['OverdueDate'], 7): This only checks whether the value is EXACTLY 7, not 'greater than or equal to 7' as the requirement asks (seven days OR MORE overdue)."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Start when: Record status changes: This configures WHEN the workflow starts running; it doesn't make it available to be called manually within the BPF — for that you must mark it as 'on demand'.",
        "As a child process: This option doesn't exist as an availability type associable with a BPF Action Step; the correct option is 'on demand'."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Pre-built template + Pre-built actions: A 'pre-built template' is not one of the two official methods of creating a flow — the two real methods are recording the screen or using pre-built actions.",
        "Record events + Visio: Recording is correct, but Visio is not a tool for creating Desktop Flows; it only helps with mapping Cloud Flows."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Using 'not(equals(...))': This would invert the logic, capturing customers WITHOUT a credit hold instead of WITH one, and it would use 'not' alone as the logical operator, which doesn't exist combined this way in the expression."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Form specific: Canvas Apps don't recognize the Model-driven concept of a 'form'; business rules in Canvas need the 'Table' scope to run on the server.",
        "Global: This would apply the rule to all tables and forms in the environment, far beyond what's needed for a single recommendation logic in the farm's canvas app."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Solution for the data (step 2): Solutions don't transport records/data, only structure; data requires the Configuration Migration tool.",
        "Migration tool for the new table (step 1): This tool is for data, not structure; a new table must be packaged in a Solution."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Embedded labels for the View + Export for the Email Template: This inverts the methods — Views use text export, and Email Templates require a separate version per language, not embedded labels.",
        "Separate version for the View + Embedded labels for the Email Template: Views are translated via text export/re-import, not by creating separate versions; this inverts the correct methods."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Delete the other address columns: This would erase data that may be used in existing integrations or reports; the requirement is only to restrict visibility, not destroy the data — that's solved with column-level security."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Restrict on delete + Cascade None on share: Restrict would block removing the parent while there are children (the expectation is Cascade All on delete), and the full combination doesn't match the expected pattern.",
        "Cascade All on both actions: Cascading all on share would automatically propagate sharing to the children, which is usually not desired — that action should be Restrict."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Create an app permission policy in the Teams admin center (alone): This action by itself doesn't automatically create the environment; it's only created when an app is actually created or installed within a team.",
        "Install an existing app + Create an app permission policy: The policy alone doesn't provision the environment; you need to create a NEW app in Teams combined with the installation."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Between two dates + By table + By column: 'Between two specified dates' is not one of the three valid options — the real option is 'Older than a specified date', with no end date.",
        "By record + Between two dates + By column: 'Between two specified dates' doesn't exist as a criterion; Dataverse only allows deleting records older than a specific date."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Enable Templates for Data Import: This configures spreadsheet templates for the user to fill in, unrelated to automatically discarding duplicates during import.",
        "Enable 'When a record is created or updated': This triggers duplicate detection in real time during normal system use, not specifically during bulk import."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Relationship in step 1: A relationship links to ANOTHER table; an alternate phone is just a text field on the Account table itself and doesn't require a relationship.",
        "Column correct in step 1, but Table in step 2: Creating a new table doesn't filter existing records; to view who has the empty field you need to create a View, not a Table."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Dataflow + View: Dataflows ingest/transform data in bulk from external sources; they don't automatically map fields between internal related tables.",
        "Alternate key + Connector: An alternate key uniquely identifies records by an alternative field, and a Connector integrates with external systems — neither one solves auto-populating related fields."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "A: read access not enabled + B: storage: If read auditing really weren't enabled, it would explain Problem A, but this option mixes in a storage issue that is not the root cause of Problem B.",
        "A: disabled at the table level + B: not enabled at the environment level: This inverts the order of the two problems' causes relative to the described scenario."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "1. Table auditing | 2. Environment auditing (inverted): Table auditing doesn't control the overall log retention policy; it's Environment auditing that defines how long logs are kept.",
        "1. Bulk deletion job | 2. Filtered view: Using a deletion job before configuring environment auditing doesn't solve auditing AND retaining for one year; a Filtered view only displays data, it doesn't delete it automatically."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Business Process Flow (BPF): This is for guiding the user through the phases of a process, not for manipulating text/strings in a field as it's typed."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Turn off 'Scale to fit' + Lock aspect ratio: The first part is correct, but 'Lock aspect ratio' keeps the width/height relationship fixed, preventing the free resizing needed for true responsiveness.",
        "Formulas for height/width + Lock orientation: The first part is correct, but locking orientation prevents adapting between portrait and landscape, contradicting responsive design."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        "No: This would be incorrect, because Relevance Search is exactly the right tool to quickly locate a record across multiple tables and open its form directly from the result link."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Send an email with a link inviting users to open the app: This doesn't control who actually HAS PERMISSION to access the app; anyone with the link would try to open it but would be blocked without the correct sharing via a security group."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "AddColumns | DropColumns: These functions manipulate columns of an existing table; they don't create a new collection or clear all of its values."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Item 3 with 'Customer' and item 4 with 'Lookup' inverted: 'Customer' is the field that accepts a Company OR a Person (item 3), and 'Lookup' points to a single specific table — this option swaps the two concepts' positions."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Dataverse Search in step 1 is correct, but 'Modern Search' is not the name of the feature that exposes data for external searches such as Bing/Office.com — that's Microsoft Search."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Open Power Apps Studio and email the zip: There is no export of an app as a generic zip file for manual handoff by email; the correct path is to download the Teams-specific package directly from the Maker Portal."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Share data and assign permissions directly (without a security role): Sharing data one piece at a time doesn't scale nor follow the per-Role security pattern with per-table permissions, which is the recommended professional approach."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "1. Building permit | 2. After school program | 3. Blank page: The Building permit template doesn't address the automated scheduling of step 1, which is the job of the Financial Institution template.",
        "1. Financial Institution | 2. Building permit | 3. After school program: Step 2 (event registration) is the job of the 'After school program' template, not 'Building permit', which focuses on request forms."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Business Rule in step 1 and BPF in step 2: A Business Rule doesn't automatically calculate a country value based on simple logic the way a Formula does, and a BPF organizes process stages, it doesn't validate expiration dates."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "UpdateContext is correct, but SaveData stores data locally on the device between sessions — it doesn't restrict the variable's scope to the current screen; that's the job of Navigate, which passes context to the target screen."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "1. Collection | 2. Global variable: A Collection is global and shared across all screens, not isolated per screen as requirement 1 asks; and general temporary data is better served by a Collection, not a global variable.",
        "Context variable correct in step 1, but Global Variable in step 2: General temporary data edited row by row is better represented by a Collection, not a simple global variable."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Connection + Collection: A Connection integrates with external services, and a Collection is an in-memory data table — neither one sends an email automatically nor controls conditional column visibility.",
        "Power Automate correct in step 1, but Business Rule in step 2: Business Rules don't exist as a conditional visibility feature in Canvas Apps; that's solved with a Formula on the Visible property."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Power Pages in step 1: This is geared toward external sites, not internal pixel-perfect layouts; that's the job of the Canvas App.",
        "Canvas app correct in step 1, but Power BI in step 2: Power BI is a reporting and dashboard tool, not an access portal for external customers to sign in and interact with data."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "A compiled language for native apps: Power Fx is interpreted/declarative, calculated in real time as the user interacts, not compiled into a separate native binary.",
        "Used exclusively for language translation: That's not the role of Power Fx; label translation is done by separate localization mechanisms, not by the formula language."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Support native Dataverse auditing: Since the data doesn't physically reside in Dataverse, the auditing engine has no way to track changes that occur in the external source."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Yes",
      "cascasDeBanana": [
        "No: this would be incorrect, because the Alternate Key creates a uniqueness constraint at the database level itself, physically blocking the creation of duplicate records with the same combination of values."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "No",
      "cascasDeBanana": [
        "Yes: this would be incorrect, because a Power Automate flow only reacts AFTER the duplicate record has already been created; it does not prevent the duplicate from being created, it could only try to fix the problem afterwards."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "No",
      "cascasDeBanana": [
        "Yes: this would be incorrect, because the duplicate detection rule only warns the user in the interface, who can ignore it and save anyway; furthermore, it does not apply to records created via API or mobile apps."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Expression: This is not a visual interface component; it's a formula concept within Power Fx, not a control you drag onto the screen to list records."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Configuration page: This is a custom screen for the user to set initial values during solution import, not a mechanism to lock/unlock editing of already-imported components."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Unmanaged solution with custom publisher: Even with the correct custom publisher prefix, an unmanaged solution allows free editing and permanent merging with the target environment, unsafe to distribute as a third-party product."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "The Configuration page: This is just a value-initialization screen during solution import; it has nothing to do with preventing duplicate logical names, which is resolved by the Publisher prefix."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Dataverse Audit history: This records who changed what data and when, but it doesn't analyze or identify syntax or logic errors in the canvas app's formulas."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Canvas app: This doesn't use merge behavior based on inherited XML components; each deployment overwrites the previous one entirely (Top Wins).",
        "Environment variables: These are simple configuration values (string/number), without per-component merge behavior like Model-driven app forms."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Connection references: These connect the app to external service credentials, but they only make sense after components that use them already exist in the solution.",
        "App configuration: This is not an initial solution-creation step; it comes later, when the app is already being built within it."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Classic workflow: This runs on the server in the background, with no ability to display an interactive recommendation on screen while the user is still filling in the form."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "New app: Creating an app doesn't define or reserve the naming prefix used in the table's fields; that's the exclusive job of the Publisher."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Data flows: An ETL and bulk-table-migration tool, purely irrelevant to user-screen logic and locking."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Word: Word templates are not automatically packaged inside the Solution; they are linked manually in each environment, requiring individual reloading.",
        "Excel: Like Word, Excel templates are not part of the automatic packaging of a Dataverse Solution; only Email Templates travel along natively."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Information form scope: This restricts the rule to a specific information-type form, but Canvas Apps don't recognize Model-driven forms; the rule simply wouldn't run."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Month: Although theoretically selectable, this is not the recommended frequency to keep workflow logs under control without accumulating excessive volume between runs — daily is ideal."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Information Form: This runs on the client side (browser), depending on the form being open; it doesn't guarantee server-side validation.",
        "Account Form: Even though it's specific to a real table, it still executes client-side, without the centralized server-side validation guarantee that the Entity scope offers."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Parallel wait branch: This executes multiple asynchronous wait branches simultaneously for future events; it doesn't check values already present in the current row or in N:1 related ones."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Update the workflow owner and cancel previous runs stuck in the Waiting state.",
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Instant workflow: This triggers manually via a button, but runs asynchronously in the background, without locking the user's screen during the calculation."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Real-time workflow to automate conversions: This automates a one-off action but doesn't create the visual stage structure that guides the salesperson through the qualification process, which is the root problem."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Instant cloud trigger: This is the trigger for a cloud flow, not a native design component within the BPF's visual structure; the correct component is the Action Step."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Create the cloud flow strictly in a default environment over Dataverse: This forces the flow to live in isolation, disconnected from the context and telemetry of the BPF that invoked it, unlike inserting it as a Flow Step within an existing Stage."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Business rule: This can only show/hide/validate fields on the form itself; it doesn't orchestrate an asynchronous, click-triggered approval within a BPF stage."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Microsoft OneDrive for Business: Being a user's personal storage space, it has no native integration for hosting Power Pages Web Files, which is done via Azure Blob Storage or directly in Dataverse."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Navigate(View.Accounts): The correct syntax doesn't use a 'View' object; you just pass the table name directly as the argument to Navigate.",
        "Accounts.Navigate(): Dot-method syntax doesn't exist in Power Fx for this purpose; the correct function is Navigate(Accounts), with the table as the parameter."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "result(): This collects results and status from loop action executions (Apply to each), with no relation to capturing the header or payload of the trigger that started the flow."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Automated cloud flow with a Switch action: The structural step is correct, but Switch compares a value against multiple discrete cases; it doesn't evaluate a 'greater than' condition — that's the job of the Condition block."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Power Pages: Geared toward public sites accessed via browser, without native access to the phone's hardware features (camera) needed to photograph products on the shelves.",
        "Dataverse for Teams: A reduced environment for simple apps within Teams, without easy access to native device features such as the camera for in-field photo capture."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Identity provider: This controls HOW the customer signs in, not WHICH pages and data they can see once authenticated — that's the job of the Web Roles."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Configure an identity provider AND assign globally open table permissions: The first part is correct, but opening permissions globally would expose sensitive data to any authenticated user.",
        "Assign web roles AND Dataverse security roles: Web roles are correct, but Dataverse security roles don't apply to external portal contacts; the identity provider is missing."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Desktop flow: This automates mouse/keyboard interactions on a PC, without a click button embeddable directly inside a Canvas App for proactive triggering."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Gallery: This is a purely visual component for displaying lists on screen, not a mechanism for storing data in memory."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Offline data source connection: This type of configuration doesn't exist natively as a Power Apps architecture feature; temporary offline retention is done via a Collection."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Configure the OnSuccess property of form1 as gallery1.Selected: OnSuccess fires AFTER the form saves successfully; it doesn't define which record the form should load and display — that's the job of the Item property."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Just reference a Table in the DataSource: Connecting directly to an online source without using Collection + SaveData breaks completely under intermittent connectivity; the app retains nothing locally."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "ClearCollect: This clears and recreates an entire table collection, aimed at reusable tabular datasets, not for holding an isolated temporary calculation value on a single screen."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Object-oriented: Power Fx doesn't use classes, inheritance, or object instances; it operates with declarative formulas that recalculate reactively, like in Excel.",
        "Strictly interpreted (procedural): It doesn't follow a rigid line-by-line sequence of commands; it's declarative — you describe the desired result and the engine decides when to recalculate."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Power BI Group Dashboard: This is a content-organization concept within the Power BI Service itself, not a type of Dynamics 365 dashboard that accepts tiles injected via the app interface.",
        "Model Form Workspace: This is not a type of dashboard; it's a form-editing area, with no support for hosting Power BI tiles."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Select the Team Template on the Security tab of the account record: This action alone doesn't expose the list of shared users on screen; you need to add the 'Users' subgrid to the form."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Base Insertion Security Role: It is not a real mapping property between Dataverse and Azure AD; the technical identifier used to link the group in a stable way is the ID (Object/Group ID)."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Office Collaborator / Creator: Aimed at end users who consume ready-made apps, without permissions to create and configure new apps, tables, and flows as the scenario requires."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Enable relevance search and delete the Quick Find View: Deleting the Quick Find View removes precisely the configuration that defines which fields are indexed for the global search, making the problem worse."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Excel spreadsheet actively connected on the web: It is a simple data source without ETL transformation capability with detection and removal of duplicates across multiple sources during the migration."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Configure a Daily Automatic Dataflow that 'wipes duplicates by nature': A Dataflow does not automatically detect and remove duplicates without a reliable incremental refresh key, which does not exist in this scenario (names repeat)."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Dynamics 365 Data Import Wizard: It is a manual tool for one-off loads via the interface, without native support for recurring scheduling or error handling like the Dataflow offers."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "A 1:N relationship with Contact as the source and Course as the target: It would bind each course to a single linked contact, which does not reflect multiple students per course.",
        "A 1:N relationship with Course as the source and Contact as the target: It would bind each contact to a single course, contradicting multiple enrollments per student."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Cascade All: In addition to deleting the parent record, it would propagate the deletion to all linked Classes, going far beyond the requirement of merely removing the link."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Remove Link + Audit: It only unlinks the product from the stock without deleting the orphaned rows, leaving loose records in the database; the requirement calls for a real cascading deletion (Cascade All)."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Cascade Active: It would only propagate the ownership change to active orders, leaving inactive/closed orders still linked to the employee who left."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Multidimensional Choice field column with an N:1 relationship: A Choice field does not create a real relationship between records of two tables; it is just a list of fixed values in a column.",
        "Simple Lookup Table with a master 1:N relationship: It would bind a contact to a single event at a time, contradicting the requirement of multiple contacts per event and vice versa."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "A 1:N relationship with Event as the parent and Contact as the child: It would bind each contact to having attended a single event throughout their entire history, which is clearly unfeasible."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Edit children: Quick Create Form | View parent: Subgrid: Quick Create is for CREATING a new child via pop-up, not editing existing ones; and a Subgrid lists multiple records, it does not summarize a single parent.",
        "Edit children: Process Flow | View parent: Embedded Chart: A Process Flow organizes phases, it does not edit children; an Embedded Chart shows aggregated data, not the details of a specific parent record."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Column-level Security: It controls which COLUMNS a user reads/edits in a record, without the ability to block access to the app by geographic location."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Dynamics 365 Portal Security and Auditing Center: It focuses on security logs within an already existing environment, not on creating, copying, or deleting entire environments.",
        "Microsoft Entra ID main panel: It manages Azure AD identities and groups, but has no controls to provision, copy, or back up Power Platform environments."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Maker-Owner Master Level: This role does not exist as a standard Dataverse security role; the correct name for someone who creates apps/flows without full administrative permissions is Environment Maker."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Canvas App + Traditional Desktop App + Power Apps Portal: Step 1 is correct, but 'Traditional Desktop App' is not a native Power Platform technology for running Canvas Apps on tablets; that is the role of the Power Apps mobile app."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Microsoft Azure SQL Database: It can be connected via custom APIs in advanced scenarios, but it is not the native, mandatory source that sustains the Portal's Forms, Views, and Roles.",
        "Microsoft Excel in the Cloud: It is a simple data source for Canvas Apps, but it does not have the relational structure, security, and forms that a Portal natively requires."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Recreate a new chatbot per Solution + Clone logic via Dataflows: Recreating from scratch would discard the bot's existing configuration, and Dataflows are for data ETL, not for cloning conversational logic.",
        "Configure Channels in local Teams + Migrate dialogs via Package: The chatbot must first be imported into the Solution (Add Existing) before any channel configuration."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Activate integration with OneDrive for Business: It is a personal storage space isolated per user, without the shared, auditable corporate structure that SharePoint offers.",
        "Acquire more Terabytes of capacity in Dataverse: It would address the symptom by paying more for the same problem, without tackling the root cause of moving heavy attachments out of the relational database."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Business Units and Security Roles",
      ...
      "cascasDeBanana": [
        ...
        "Business Rules: They serve to apply logic on forms (e.g., making a field mandatory); they do not control who can view or edit records in the database."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Decimal alone: It is merely the numeric data type stored in the field, without any periodic aggregation logic of related child records."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Rollup: This field type asynchronously aggregates values from child records (sums, counts); it has no function to detect or block duplicate records during data entry."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "They still have no access because they lack the base Read level in their Role",
      ...
      "cascasDeBanana": [
        ...
        "Becoming a System Admin: Sharing only affects a specific record and never elevates the user's general platform privileges."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Audit and Plugin logic",
      ...
      "cascasDeBanana": [
        ...
        "Plugins only: Disabling plugins helps, but Auditing also generates enormous overhead on the database during thousands of insertions."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Model Builder (App Designer): You use the App Designer to choose which tables will be part of the app itself, but the exact hierarchical menu structure is built in the Sitemap tab."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "ViewForm alone: It displays the data only in read-only mode in the Form control, without any ability to write or update the record in the data source."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Only the first 500 or 2,000 records will be downloaded to be filtered on the user's device",
      ...
      "cascasDeBanana": [
        ...
        "Deactivates the M365 license: The delegation warning is a technical behavior of the Power Apps query engine, unrelated to the user's licensing status."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "SaveData and LoadData",
      ...
      "cascasDeBanana": [
        ...
        "Start and Stop: These are not real Power Fx functions for data persistence; storing and reading data offline requires specifically SaveData() and LoadData() with a Collection."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Scheduled (Recurrence)",
      ...
      "cascasDeBanana": [
        ...
        "'When an item is Modified' alone: It is a reactive trigger that fires upon detecting a change to an existing record, not a schedule based on a fixed time like midnight."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Condition: It evaluates a logical expression (true/false) to branch the flow into two paths, without the ability to interpret a JSON string and transform it into dynamic properties."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Configure 'Run After' to ignore failures",
      ...
      "cascasDeBanana": [
        ...
        "Add a Terminate action: This would force the flow to stop immediately with an error status, which is the opposite of what we want."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Python: It is not natively supported as a server-side template/logic language within Power Pages pages; the native language for that is Liquid."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "System Admin Role: This is an internal Dataverse administrative role, not a Power Pages Web Role used to manage how visitors who are not logged in access the portal."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "In Environment Variables",
      ...
      "cascasDeBanana": [
        ...
        "Local XML files: Dataverse is a cloud SaaS; we do not read XML files saved locally on the developer's machine to fetch credentials."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Code-only: There is no solution type called 'Code-only' in the Power Platform; every solution is always Managed or Unmanaged, regardless of whether it contains custom code."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Power BI Dashboard: It serves to show data by generating reports, not to physically write/insert billing data into the Dataverse table."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Image Control: The image control only DISPLAYS an image already saved or pulled from the database; it does not activate the live camera to capture the moment."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Automated Cloud Flow",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Options that require M365 global administration are generally wrong for PL-200 Functional Consultants.",
        "Desktop Flow (RPA): It is used for mouse clicks on legacy systems, not for reacting automatically to an external form submission."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Security Roles",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Options that require M365 global administration are generally wrong for PL-200 Functional Consultants.",
        "Table Security Permissions: They control access to the entire table (create, read, edit, delete rows); they do not restrict the visibility of a specific column such as a national ID number."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Wait for an approval",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Options that require M365 global administration are generally wrong for PL-200 Functional Consultants.",
        "Canvas App Embed: It embeds an entire Canvas App inside a form, but it does not create the native sequential navigation stage bar that the scenario requires."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Canvas Component",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Options that require M365 global administration are generally wrong for PL-200 Functional Consultants.",
        "Asynchronous Dynamics Workflow: It is the older classic technology, without native support for recurring scheduling at a fixed time the way Power Automate offers."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "List Component",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Options that require M365 global administration are generally wrong for PL-200 Functional Consultants.",
        "Power Automate with an edit trigger: It runs asynchronously after the data has already been saved; it does not prevent typing a negative value in real time the way a Business Rule does."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Power BI Workspace",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Options that require M365 global administration are generally wrong for PL-200 Functional Consultants.",
        "Open Microsoft Forms: It is a simple forms and surveys tool, without any ability to give authenticated, secure access to an entire Model-driven app."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "System Fallback",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Options that require M365 global administration are generally wrong for PL-200 Functional Consultants.",
        "Reset Loop: It is not a native Power Virtual Agents mechanism; when the bot does not understand a phrase, the default behavior is to trigger the Fallback Topic, not to restart the conversation."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Sandbox Environment",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Options that require M365 global administration are generally wrong for PL-200 Functional Consultants.",
        "Using Power Automate to return a string: Calling a cloud flow to obtain the logged-in user's name is needlessly heavy; Power Fx already has the native User().FullName function."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Options that require M365 global administration are generally wrong for PL-200 Functional Consultants.",
        "Writing an old classic .NET workflow: Reverting to legacy technology does not solve the infinite loop; the problem is structural in the trigger and would recur without proper trigger conditions."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Recurrence Trigger",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Image Box: The Image Control would show only a static 'print', without interactivity or real-time data filters.",
        "Data Table Component: It displays tabular data from a connected source; it does not render interactive Power BI Service dashboard visuals."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Gallery component",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Canvas App Collections: The bot runs on its own conversation engine, independent of Power Apps' local in-memory collections (ClearCollect).",
        "In an attached Excel file: PVA has no native ability to write conversation responses directly to an attached Excel file; short-term memory is managed by Topic Variables."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Push Notification",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Quick Find View: Quick search works only on the table you are currently viewing.",
        "Quick Find View: It configures which fields appear in a specific table's quick search, but it is not the global multi-table search mechanism itself."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Audit logs",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Entra ID Roles: They control access to the system, not the traffic of connectors and APIs.",
        "Removing the Office E5 license: Revoking the license would block the user's access to ALL of Microsoft 365, a disproportionate measure unrelated to granular connector control."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Power BI Report",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Sending a PDF: It violates the principle of integrated, real-time, interactive systems.",
        "Sending a PDF via Automate and displaying it as a Timeline: It generates only a static file on the timeline, losing all interactivity and real-time updating."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Greeting Topic",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Developer Environment: It is for individual use; a Sandbox is for teams to test together.",
        "Handling heavy daily API calls: API processing capacity is not the purpose of a Sandbox; it exists to isolate testing and development before production."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "N:1 Relationship (Many-to-One)",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Escalation: It is the topic for talking to a human, but it is called from within the Fallback or by keywords.",
        "Dialog Root: It is not a native concept or component of Power Virtual Agents; unrecognized messages are handled by the Fallback system topic."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Configure Run After",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Dataverse Table: It saves permanently to the database, but the question focuses on 'storing for use within the conversation flow (the bot's RAM memory)'.",
        "Session Storage: It is a web browser storage concept, not a native feature of the PVA topic editor for keeping data during the conversation."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Model Business Rule",
      "puloDoGato": "Did you identify the main resource listed? It solves the system gap.",
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "End of Topic: It merely ends the chat with the customer.",
        "End User Request: It is not the name of a native PVA node for transferring service; the official mechanism is the Hand-off integrated with Omnichannel."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "SharePoint link: It merely directs to a SharePoint file or page, without interactively rendering a Power BI report inside the portal with proper authentication."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        "Other options, although feasible via pro code, violate the premise of native corporate platform use.",
        "Complex code options tend to be incorrect on this exam.",
        "Event Grid: It is an Azure event-routing service geared toward pro-code architectures; it is not the simplest recommended integration for triggering a dataset refresh."
      ],
      "dicaOuro": "Power BI, Pages, and Virtual Agents (Bots) represent up to 20% of the score. Don't memorize code, memorize the visual component."
    }
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Anonymous Authentication Enabled",
      "puloDoGato": "Did you identify the integration resource? It is the 'standard' connection solution.",
      "cascasDeBanana": [
        "Other options, although feasible via pro code, violate the premise of native corporate platform use.",
        "Complex code options tend to be incorrect on this exam.",
        "B2B AD Guest: It is aimed at inviting specific, known external users with a login, the opposite of the anonymous, unrestricted access the scenario requires."
      ],
      "dicaOuro": "Power BI, Pages, and Virtual Agents (Bots) represent up to 20% of the score. Don't memorize code, memorize the visual component."
    }
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "List Component (Entity List)",
      "puloDoGato": "Did you identify the integration resource? It is the 'standard' connection solution.",
      "cascasDeBanana": [
        "Other options, although feasible via pro code, violate the premise of native corporate platform use.",
        "Complex code options tend to be incorrect on this exam.",
        "Canvas Gallery: It is a Canvas Apps component, not part of Power Pages; portals use the native List Component to display Dataverse records in a paginated list."
      ],
      "dicaOuro": "Power BI, Pages, and Virtual Agents (Bots) represent up to 20% of the score. Don't memorize code, memorize the visual component."
    }
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Bot Variable",
      "puloDoGato": "Did you identify the integration resource? It is the 'standard' connection solution.",
      "cascasDeBanana": [
        "Other options, although feasible via pro code, violate the premise of native corporate platform use.",
        "Complex code options tend to be incorrect on this exam.",
        "Action Flow: It is not a native term or feature of Power Virtual Agents; handling unrecognized messages is the role of the Fallback system topic."
      ],
      "dicaOuro": "Power BI, Pages, and Virtual Agents (Bots) represent up to 20% of the score. Don't memorize code, memorize the visual component."
    }
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Dataverse Table: It serves for permanent persistence, not for temporary chat variables.",
        "Session Storage: A web browser storage term, not a native feature of the PVA topic editor for maintaining data during the conversation."
      ],
      "dicaOuro": "Anchor your knowledge: The right tool is almost always N:1 Relationship (Many-to-One)."
    }
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "Trigger Actions: They start conversations, they do not transfer them.",
        "End User Request: It is not the name of a native PVA node for transferring service; the official mechanism is the Hand-off integrated with Omnichannel."
      ],
      "dicaOuro": "Anchor your knowledge: The right tool is almost always Configure Run After."
    }
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        "Avoid choosing 'Desktop Flow (RPA)', as it would force a process redesign.",
        "SharePoint links: They are not ideal for portals aimed at external customers.",
        "Native IFrame tag: Using raw HTML without the dedicated Power BI component can cause authentication and responsiveness problems in the portal."
      ],
      "dicaOuro": "Anchor your knowledge: The right tool is almost always Model Business Rule."
    }
  },
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        "Other options, although feasible via pro code, violate the premise of native corporate platform use.",
        "Complex code options tend to be incorrect on this exam.",
        "Entra ID required: It would force mandatory authentication, which goes exactly against the goal of allowing viewing without login."
      ],
      "dicaOuro": "Power BI, Pages, and Virtual Agents (Bots) represent up to 20% of the score. Don't memorize code, memorize the visual component."
    }
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        "Other options, although feasible via pro code, violate the premise of native corporate platform use.",
        "Complex code options tend to be incorrect on this exam.",
        "Canvas Gallery: It is a Canvas Apps component, not native to Power Pages Studio for displaying lists of Dataverse records on pages."
      ],
      "dicaOuro": "Power BI, Pages, and Virtual Agents (Bots) represent up to 20% of the score. Don't memorize code, memorize the visual component."
    }
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Separate it into two flows: one creates the approval ('Create an approval') and another is triggered via Webhook when the approval status in Dataverse changes.",
      ...
      "cascasDeBanana": [
        ...
        "Delay until configured for a static date: It would pause the flow until a fixed date, without dynamically reacting to the actual moment when the director truly approves or rejects."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The flow entered an Infinite Trigger Loop.",
      ...
      "cascasDeBanana": [
        ...
        "The user lacks a Premium license for Dataverse: A licensing limitation would generate a permission error when saving, not the extreme slowness followed by automatic suspension typical of an infinite loop."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Enable 'Concurrency Control' in the 'Apply to each' settings.",
      ...
      "cascasDeBanana": [
        ...
        "Use a 'Do until' action: A loop that repeats until a condition is met does not parallelize the work; the items would still be handled one by one, without solving the slowness."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Transform the flow using a 'Run-only permission' and transfer ownership to a Service Account or add colleagues as Co-owners.",
      ...
      "cascasDeBanana": [
        ...
        "Change the trigger to 'Scheduled': A scheduled flow does not react to the colleague's form submission; it would still depend on the creator's personal connection."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Select Columns: statuscode, prioritycode",
      ...
      "cascasDeBanana": [
        ...
        "Select Columns with 'status, priority': The field requires the exact logical names of the columns (e.g., statuscode, prioritycode), not the friendly display names."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The action has a native limit and will only process the first 500 pages of the document; if the information is beyond that, it will not be read.",
      ...
      "cascasDeBanana": [
        ...
        "Use 'Parse JSON' instead: Parse JSON only structures already-extracted JSON data; it does not read the content of a scanned PDF document, which is the role of the AI Builder Document Processing model."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Add a 'Flow Step' to the Qualify stage in the BPF editor and check the 'When a flow step is run' trigger.",
      ...
      "cascasDeBanana": [
        ...
        "Only via JavaScript (Client API): It is not the only way; modern BPFs natively support adding a Flow Step without writing code."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Enable the 'Secure Inputs' and 'Secure Outputs' security options in the action's Settings.",
      ...
      "cascasDeBanana": [
        ...
        "Hide the flow from the public gallery: This controls the flow's visibility to other makers in the Maker Portal, with no effect on what is displayed in the run history."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The child flow must be inside a Solution and use the manual or Power Apps trigger.",
      ...
      "cascasDeBanana": [
        ...
        "Published in the template gallery: Templates are models for creating NEW flows; this is not a technical requirement for an existing flow to be called as a Child Flow."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "A 'Switch' control.",
      ...
      "cascasDeBanana": [
        ...
        "An array using Filter: Filter() selects items from an existing collection; it is not a control structure for branching execution into multiple mutually exclusive paths."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "A Custom Entity using Regular Expression (Regex) Rules or Closed List.",
      ...
      "cascasDeBanana": [
        ...
        "A global variable: It stores simple values that have already been captured; it has no ability to EXTRACT or recognize a specific pattern of typed text, which is the role of Entities."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Configure Authentication using Azure AD, setting the bot to require Logon and using native user profile variables.",
      ...
      "cascasDeBanana": [
        ...
        "Forcefully publish the bot on a public SharePoint portal: Hosting the bot on a site has no relation to the Azure AD Authentication mechanism used to identify the user."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Use Topic Variables instead of action parameters, allowing you to manage conversation flow with conditional nodes and questions that evaluate if the variable already has a value.",
      ...
      "cascasDeBanana": [
        ...
        "Increase the session timeout limit: Extending the session time does not give the bot the ability to remember and conditionally reuse a variable's value mid-conversation."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Use the Conversational Boosting (Generative Answers) feature and provide the intranet page URL for the bot to learn the content dynamically.",
      ...
      "cascasDeBanana": [
        ...
        "Create an Entity with the copied-and-pasted policy and use Regex: Manually pasting a long policy and parsing it with Regex is unfeasible to maintain and does not dynamically learn content updated on the intranet page."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The bot must be connected to an omnichannel engagement hub, such as Omnichannel for Customer Service (Dynamics 365) or an equivalent provider.",
      ...
      "cascasDeBanana": [
        ...
        "Purchase a Power BI Premium license: It has no relation whatsoever to the real-time chat routing infrastructure needed for the human handoff."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The Bot will display the 'Did you mean' menu, showing a multiple-choice menu for the user to define the correct context.",
      ...
      "cascasDeBanana": [
        ...
        "The bot will randomly select one of the topics: The recognition engine never resolves ambiguity by chance; it uses confidence scores and disambiguation, not randomness."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "At the end of the Power Automate flow, you must add the 'Respond to a Power Virtual Agent or Power Apps' action and define the textual output fields in it.",
      ...
      "cascasDeBanana": [
        ...
        "Export the flow within a Solution: Packaging into a Solution is an ALM practice, unrelated to making the flow's output variable visible in the PVA panel."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "It visually shows which node and which topic are being executed in real-time alongside the conversation, automatically switching screens if the conversation goes to another Topic.",
      ...
      "cascasDeBanana": [
        ...
        "It enables global variable reading: The live tracking pane visualizes the executed topic and node path; it is not a tool for reading or editing global variables."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "You can use 'Message' nodes and use the Bot Framework Composer to inject Adaptive Card JSON onto the screen.",
      ...
      "cascasDeBanana": [
        ...
        "This requires an Azure Cognitive Services license and a custom bot in C#: Adaptive Card injection is already supported natively via Bot Framework Composer, without requiring custom C#."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The 'End of Conversation' system topic was not called at the end of the created flows, leaving the native satisfaction survey out.",
      ...
      "cascasDeBanana": [
        ...
        "The bot must be in a Power Pages portal to collect CSAT: The satisfaction survey is native to the PVA conversation engine, working on any channel."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "In the Power Platform admin portal, it is mandatory to enable the 'Allow Power BI embedding' option in the Environment properties.",
      ...
      "cascasDeBanana": [
        ...
        "Install Power BI Desktop on the company's local IIS server: It is a local authoring tool for creating reports, with no role in configuring embedding for the Dataverse environment."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The use of the 'Power BI Tile' visual control passing the filter string as a property or through 'PowerAppsIntegration' configured in the Power BI panel.",
      ...
      "cascasDeBanana": [
        ...
        "The Run() button on OnSelect: It executes Power Automate flows from a button, unrelated to the bidirectional interaction between an embedded report and the screen's data."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Use the 'When a data driven alert is triggered' trigger in Power Automate to read the event and send the message in Teams.",
      ...
      "cascasDeBanana": [
        ...
        "Right-click and select 'Integrate Teams': There is no native dashboard option that automatically pushes a Teams message when a value changes; this requires a Power Automate alert trigger."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Re-import using the native Dataverse connector, as it provides a native expanded column (e.g., 'statecodeName') that already converts the logical value to the display string.",
      ...
      "cascasDeBanana": [
        ...
        "Use the legacy connector (OData) without authentication: It does not automatically expand Choice columns into readable text the way the modern native Dataverse connector does."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The report connections will remain tied to the development (DEV) database, unless you create and map Environment Variables pointing to the correct Workspace and Dataset before Deploy.",
      ...
      "cascasDeBanana": [
        ...
        "The solution will mandatorily fail: The import itself does not fail because of the Power BI component; the report is imported normally, keeping the old connection until reconfigured."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Create a Business Rule.",
      ...
      "cascasDeBanana": [
        ...
        "Configure visibility in the App Designer: The App Designer defines which components are in the app, but it does not apply conditional, real-time field visibility based on another field's value."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Navigate(Screen2, ScreenTransition.Fade)",
      ...
      "cascasDeBanana": [
        ...
        "Navigate(Screen2; Transition: Fade): This syntax with a semicolon and a named parameter does not exist in Power Fx; the parameter is positional and uses ScreenTransition.Fade."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Replace ClearCollect with query delegation and dynamic filtering directly in the gallery.",
      ...
      "cascasDeBanana": [
        ...
        "This is impossible in a Canvas App: It is possible to work with thousands of records, as long as you avoid loading everything into a local collection and use direct delegation to the data source."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Identity Providers via Azure AD B2C.",
      ...
      "cascasDeBanana": [
        ...
        "Power Automate Premium Connectors: They relate to licensing automation in flows, with no role in configuring the portal's social login mechanism."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Business Process Flow.",
      ...
      "cascasDeBanana": [
        ...
        "Power Automate Desktop: It is an RPA automation tool for clicks on legacy apps, unrelated to phase-based navigation of a record within the form."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The context is automatically passed via ModelDrivenFormIntegration.Item.",
      ...
      "cascasDeBanana": [
        ...
        "Through a temporary SQL table: It would be unnecessarily complex; the record context is already natively injected by the ModelDrivenFormIntegration component."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Configure Table Permissions for 'Account' or 'Contact' access and associate them with a Web Role.",
      ...
      "cascasDeBanana": [
        ...
        "Create a Business Rule on the portal: Business Rules do not exist in Power Pages; controlling which rows a visitor sees is done via Table Permissions associated with a Web Role."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "UpdateContext(): It creates and updates local screen context variables, unrelated to validating and submitting the data of a Form control to the data source."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Solutions allow grouping apps, flows, and tables into a single package to transport them between environments (DEV > PRD).",
      ...
      "cascasDeBanana": [
        ...
        "Solutions provide free licenses to users: Licensing is managed separately in the Microsoft 365 Admin Center; Solutions do not grant usage licenses."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The app waits for the user to stop typing for half a second before firing heavy Search() queries, saving requests.",
      ...
      "cascasDeBanana": [
        ...
        "It saves locally before going to the cloud: DelayOutput has no relation to offline cache; it is merely a delay in firing the query to reduce redundant calls."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Through native State and Status behavior (Statecode / Statuscode), where Deactivated/Inactive records automatically become Read-Only.",
      ...
      "cascasDeBanana": [
        ...
        "Using a Flow that checks and locks fields: A flow runs asynchronously on the server after saving; it cannot lock the form in real time the way the record's native Inactive state does."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Child records remain in the database, but the lookup column to the Parent becomes empty (null).",
      "puloDoGato": "Key insight: Referential = 'just points; if it disappears I don't care' (Removes link). Parental = 'born together, die together' (Cascade Delete).",
      "cascasDeBanana": [
        "Cascade Delete: This is the behavior of a 'Parental' relationship.",
        "Prevents Parent deletion: This is Restrict Delete behavior.",
        "All Child records are reassigned to the Administrator: Deleting a parent never transfers ownership of child records to the admin; that is not a referential behavior."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Create a Power Automate flow using the 'When a record is deleted' trigger, which runs in the background inserting the copied record into the 'Recycle Bin'.",
      ...
      "cascasDeBanana": [
        ...
        "Create a Business Rule on the form: Business Rules act on the UI during editing, without the ability to react to a record's deletion or insert data into another table."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Use the Share button individually on the 5 records, granting Read permission.",
      ...
      "cascasDeBanana": [
        ...
        "Create a new Model-driven app just for them: Creating an app does not change the underlying data permissions; without access via Security Role or Share, they would still not see the Opportunities."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Enable Field-level Security for the field and create a Column Security Profile.",
      ...
      "cascasDeBanana": [
        ...
        "A Business Rule that checks the username: It is a UI solution that is easily bypassed (Excel, API), and checking names individually does not scale like column security profiles do."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Choice, preferably a Global Choice.",
      ...
      "cascasDeBanana": [
        ...
        "Text (Single Line): It would allow free, inconsistent typing (e.g., 'a+', 'A positive type'), without standardization or validation of the expected fixed options."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "In Dataverse File Storage (internal Azure Blob), ensuring lower cost and optimization.",
      ...
      "cascasDeBanana": [
        ...
        "Directly in the user's browser: A browser does not durably store enterprise file attachments; uploaded files must reside in server-side capacity, not on the client."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The Ownership type, from 'User or Team' to 'Organization'.",
      ...
      "cascasDeBanana": [
        ...
        "Enabling Dataverse Search: This is a reversible setting that can be turned on or off at any time, unlike the ownership type which is fixed at creation."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "In the Relationships tab, clicking Add and choosing the Many-to-Many (N:N) type. Dataverse creates the intersection table itself.",
      ...
      "cascasDeBanana": [
        ...
        "Creating Multi-select Choice fields in both tables: A multi-select choice only stores a list of fixed values in a column; it does not create a true relationship linking records of the two tables."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "App: It is not a valid Business Rule scope; the real scopes are Entity, All Forms, and a specific Form — App does not control server-side execution."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "By creating a DLP (Data Loss Prevention) policy in the Admin Center.",
      ...
      "cascasDeBanana": [
        ...
        "In the Solution scope: A Solution is an ALM packaging container; it does not define tenant-wide connector governance, which is set through a DLP policy."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Upgrade (full upgrade): It removes orphaned components from the previous version, causing more impact than the desired partial update intended to minimize downtime."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "At least 1 GB of available Database Capacity in the tenant.",
      ...
      "cascasDeBanana": [
        ...
        "Being the CEO of the organization: Provisioning an environment requires the appropriate admin role and available capacity, not any specific job title."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The Default Environment is accessible to everyone in the company (everyone has Maker permissions) and should not be used for critical or confidential solutions.",
      ...
      "cascasDeBanana": [
        ...
        "The app does not support the Office 365 connector: The Default Environment has full access to the same connectors as any other environment; the real risk is the lack of governance."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Reset the environment.",
      ...
      "cascasDeBanana": [
        ...
        "Manual backup: Creating a backup merely saves a copy of the current state; it does not wipe sensitive data while preserving the apps and configurations as a Reset does."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Dataflows using a Data Gateway.",
      ...
      "cascasDeBanana": [
        ...
        "Azure Logic Apps via webhook: It is a pro-code Azure integration tool, outside the native low-code scope recommended for scheduled ETL directly into Dataverse."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Dataflows: They physically copy the data extracted from SAP into Dataverse storage, directly violating the prohibition on duplicating data.",
        "Asynchronous Power Automate synchronization: It would also result in a physical copy of the data written to Dataverse on each run, exactly what the company forbids."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Business Process Flow: It guides a record through sequential stages; it does not render a list of multiple records in a Kanban-style visual board."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Microsoft Dataverse and the Finance & Operations (Dynamics 365) database synchronously and bidirectionally.",
      ...
      "cascasDeBanana": [
        ...
        "DEV and PRD Dataverse environments: Dual-write does not synchronize different environments of the same platform; it integrates Dataverse with Finance & Operations (ERP)."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "In the user's Security Role, under the 'Business Management' or Privacy tab, adjusting the 'Export to Excel' privilege.",
      ...
      "cascasDeBanana": [
        ...
        "In the Business Process Flow: BPFs organize the visual phases of a process, unrelated to data export privileges controlled by the Security Role."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Custom API or Plugins developed in .NET/C# and registered on the platform.",
      ...
      "cascasDeBanana": [
        ...
        "Only legacy workflows: Classic workflows have limited capabilities and do not achieve the performance or code flexibility needed for each API operation."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "An entity that defines the prefix (e.g., abc_) that will be attached to the name of tables and fields created in that solution.",
      ...
      "cascasDeBanana": [
        ...
        "An Office suite app: A Publisher is metadata that defines the customization prefix; it is not an application from the Office suite."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "cascasDeBanana": [
        ...
        "Global Dashboard: It presents aggregated charts and lists across the whole app, not a condensed side-panel view of related data within a single record."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Configure a Component Library and publish it.",
      ...
      "cascasDeBanana": [
        ...
        "There is no way to share visual components between apps: This is false; the native Component Library exists precisely to reuse components across multiple apps."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Concat(Gallery.AllItems, EmployeeName, ', ')",
      ...
      "cascasDeBanana": [
        ...
        "Lookup(): It returns only the FIRST record that meets a condition; it does not iterate and concatenate the names of all 20 employees into a single string."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The AccessibleLabel property filled in clearly and descriptively.",
      ...
      "cascasDeBanana": [
        ...
        "Mandatory use of the button's native high-contrast colors: It helps low-vision users, but it communicates nothing to a screen reader for fully blind users; that depends on the AccessibleLabel."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Use the native List and Basic/Multistep Form components linked to Dataverse in the Design Studio interface.",
      ...
      "cascasDeBanana": [
        ...
        "Create a Power Automate flow that generates HTML and embeds it: It would be a fragile, non-standard solution; Power Pages already offers native List and Form components bound to Dataverse."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "The system automatically synchronizes locally cached transactions in the background as soon as connectivity is restored and maintained, following the sync profile.",
      ...
      "cascasDeBanana": [
        ...
        "Local data is lost: Offline transactions are safely cached on the device and are never discarded; they are synced once connectivity returns."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Microsoft Teams (Approvals App component).",
      ...
      "cascasDeBanana": [
        ...
        "Dataverse Web API: It is a programming interface for developers to access data via code, not a ready-made interface application for approvals by the end user."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "By enabling the Pagination feature in the action's Settings and setting the threshold above the expected number.",
      ...
      "cascasDeBanana": [
        ...
        "Split the flow into 35 subflows: Manually splitting into dozens of subflows is impractical and unnecessary, since native Pagination retrieves all records within a single action."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Respond to a PowerApp or flow.",
      ...
      "cascasDeBanana": [
        ...
        "Condition: It only branches the flow's execution into two logical paths, without the ability to return data or status to the Canvas App that triggered the flow."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Through the 'Run History' tab on the flow details page, clicking on the exact execution.",
      ...
      "cascasDeBanana": [
        ...
        "In the Dataverse Solution Explorer: The Solution Explorer manages components and metadata; it does not display the run history of individual flow executions."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Use the 'Approve/Reject - Everyone must approve' type and add a condition if the Outcome is not equal to 'Approve'.",
      ...
      "cascasDeBanana": [
        ...
        "It is impossible to force an email if one user rejects before the others: This is false; using 'Everyone must approve' with a condition on the outcome handles exactly this case."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "By creating an authorized Connection that stores the token and linking it to the Action in the flow.",
      ...
      "cascasDeBanana": [
        ...
        "Exporting to a ZIP package: Packaging the connector into a ZIP serves to transport it between environments (ALM), but it does not solve the secure, reusable storage of the authentication token."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Send an email from a shared mailbox.",
      ...
      "cascasDeBanana": [
        ...
        "It is impossible to send using emails from general mailboxes: This is false; the Office 365 Outlook connector has the native 'Send an email from a shared mailbox' action made exactly for this."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "In the Web channel Management tab, enable Web Channel Security / Require user to sign in.",
      ...
      "cascasDeBanana": [
        ...
        "Delete the bot every night and reinstall it: It is an extremely disruptive measure and still would not prevent anyone from accessing it via iframe during the period the bot is active."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Add the Power BI report directly to the Sitemap as a 'Web Resource / Subarea URL' or use the native component tab in System Dashboards.",
      ...
      "cascasDeBanana": [
        ...
        "It is necessary to use Canvas Apps: This adds unnecessary complexity; Model-driven apps natively support hosting Power BI reports in workspace tabs without resorting to Canvas Apps."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "DirectQuery requires frequent and direct queries against Dataverse for every click or filter by every user. With tens of millions of rows and dozens of filters, this severely consumes Dataverse daily API limits (Service Protection Limits) and degrades report loading times to frustrating levels.",
      ...
      "cascasDeBanana": [
        ...
        "It requires E5 Enterprise licensing: The performance concern with DirectQuery stems from API/service protection limits, not from any specific licensing tier."
      ],
  ...
  },
  {
    ...
    "explanation": {
      ...
      "respostaCerta": "Within the Dataverse database linked to the Environment where the Bot was deployed (in the 'SessionTranscripts' table).",
      ...
      "cascasDeBanana": [
        ...
        "In a text file in Azure: Enterprise bot transcripts are stored as structured records in the native Dataverse database, not as loose text files in Azure."
      ],
